...
### `filterElements(`java.util.List<ro.sync.contentcompletion.xml.CIElement>` elements, [`ro.sync.contentcompletion.xml.WhatElementsCanGoHereContext`](./WhatElementsCanGoHereContext.md) context)`
...
### `filterAttributes(`java.util.List<ro.sync.contentcompletion.xml.CIAttribute>` attributes, [`ro.sync.contentcompletion.xml.WhatAttributesCanGoHereContext`](./WhatAttributesCanGoHereContext.md) context)`
...
### `filterAttributeValues(`java.util.List<ro.sync.contentcompletion.xml.CIValue>` attributeValues, [`ro.sync.contentcompletion.xml.WhatPossibleValuesHasAttributeContext`](./WhatPossibleValuesHasAttributeContext.md) context)`
...
### `filterElementValues(`java.util.List<ro.sync.contentcompletion.xml.CIValue>` elementValues, [`ro.sync.contentcompletion.xml.Context`](./Context.md) context)`
