...
**Fully Qualified Name:** `ro.sync.ecss.extensions.tei.TEI_jteiExtensionsBundle`

**Extends:** [`ro.sync.ecss.extensions.tei.TEIExtensionsBundleBase`](./TEIExtensionsBundleBase.md)
...
**Type:** [`ro.sync.ecss.extensions.tei.TEIAuthorTableOperationsHandler`](./TEIAuthorTableOperationsHandler.md)

### `uniqueAttributesRecognizer`

**Type:** [`ro.sync.ecss.extensions.tei.id.TEIP5UniqueAttributesRecognizer`](id/TEIP5UniqueAttributesRecognizer.md)
