...
### `updateTableColumnNumber([`ro.sync.ecss.extensions.api.AuthorAccess`](../api/AuthorAccess.md) authorAccess, [`ro.sync.ecss.extensions.api.node.AuthorElement`](../api/node/AuthorElement.md) tableElement, `int` colNumber)`
