...
**Fully Qualified Name:** `ro.sync.ecss.extensions.api.webapp.DPILocation`
...
- `endLocation` (`int`): End offset of the dpi (exclusive).
- `nodeIds` (`java.util.List<java.lang.Long>`): The nodes marked by the dpi.
