...
### `<init>([`ro.sync.ecss.extensions.api.node.AuthorElement`](../../api/node/AuthorElement.md) map)`
...
### `computeAreas([`ro.sync.ecss.extensions.api.node.AuthorElement`](../../api/node/AuthorElement.md) map)`

**Returns:** `java.util.List<ro.sync.ecss.extensions.api.webapp.imagemap.WebappAreaView>`

### `areaToAreaView([`ro.sync.ecss.extensions.api.node.AuthorElement`](../../api/node/AuthorElement.md) area, `int` originalLayer)`
...
### `parseCoords([`ro.sync.ecss.extensions.api.node.AuthorElement`](../../api/node/AuthorElement.md) area)`
