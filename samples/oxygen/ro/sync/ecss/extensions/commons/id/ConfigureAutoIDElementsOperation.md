...
**Fully Qualified Name:** `ro.sync.ecss.extensions.commons.id.ConfigureAutoIDElementsOperation`
...
### `getDefaultOptions(ro.sync.ecss.extensions.api.AuthorAccess authorAccess)`
