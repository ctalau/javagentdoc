...
### `insertImageRef([`ro.sync.ecss.extensions.api.AuthorAccess`](../api/AuthorAccess.md) authorAccess, `ro.sync.ecss.docbook.DocBookImageInfo` imageInfo, `boolean` isInlineGraphicAccepted)`
