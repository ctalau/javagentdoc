# Class: `DocBook4ExtensionsBundle`

**Package:** [`ro.sync.ecss.extensions.docbook`](README.md)

**Fully Qualified Name:** `ro.sync.ecss.extensions.docbook.DocBook4ExtensionsBundle`

**Extends:** [`ro.sync.ecss.extensions.docbook.DocBookExtensionsBundleBase`](./DocBookExtensionsBundleBase.md)
...
**Type:** [`ro.sync.ecss.extensions.docbook.DocbookAuthorTableOperationsHandler`](./DocbookAuthorTableOperationsHandler.md)

### `uniqueAttributesRecognizer`

**Type:** [`ro.sync.ecss.extensions.docbook.id.Docbook4UniqueAttributesRecognizer`](id/Docbook4UniqueAttributesRecognizer.md)

### `schemaAwareEditingSupport`

**Type:** [`ro.sync.ecss.extensions.docbook.DocbookSchemaAwareEditingHandler`](./DocbookSchemaAwareEditingHandler.md)
