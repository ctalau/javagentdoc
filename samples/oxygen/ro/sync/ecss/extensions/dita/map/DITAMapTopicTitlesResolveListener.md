...
**Fully Qualified Name:** `ro.sync.ecss.extensions.dita.map.DITAMapTopicTitlesResolveListener`

**Implements:** [`ro.sync.ecss.extensions.api.AuthorExtensionStateListener`](../../api/AuthorExtensionStateListener.md)
