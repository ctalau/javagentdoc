# Class: `TopicReferencesViewModeOperation`

**Package:** [`ro.sync.ecss.extensions.dita.map.topicref`](README.md)

**Fully Qualified Name:** `ro.sync.ecss.extensions.dita.map.topicref.TopicReferencesViewModeOperation`
...
This mode is the default one and exists only to deactivate 
 TopicContentViewModeOperation and TopicContentViewModeOperation.
