...
**Fully Qualified Name:** `ro.sync.ecss.extensions.dita.map.DITAMapExtensionsBundle`

**Extends:** [`ro.sync.ecss.extensions.dita.DITAExtensionsBundle`](../DITAExtensionsBundle.md)
...
**Type:** [`ro.sync.ecss.extensions.dita.map.DITAMapAuthorTableOperationsHandler`](./DITAMapAuthorTableOperationsHandler.md)

### `ditaMapSchemaAwareEditingHandler`

**Type:** [`ro.sync.ecss.extensions.dita.map.DITAMapSchemaAwareEditingHandler`](./DITAMapSchemaAwareEditingHandler.md)
