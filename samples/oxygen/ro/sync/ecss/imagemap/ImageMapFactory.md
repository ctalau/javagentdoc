...
**Package:** [`ro.sync.ecss.imagemap`](README.md)

**Fully Qualified Name:** `ro.sync.ecss.imagemap.ImageMapFactory`

## Fields

### `b`

**Type:** [`ro.sync.ecss.imagemap.ImageMapFactory`](./ImageMapFactory.md)
...
**Returns:** [`ro.sync.ecss.imagemap.ImageMapFactory`](./ImageMapFactory.md)

### `getImageMap([`ro.sync.ecss.imagemap.SupportedFrameworks`](./SupportedFrameworks.md) arg0, [`ro.sync.ecss.extensions.api.AuthorAccess`](../extensions/api/AuthorAccess.md) arg1, `int` arg2, `java.net.URL` arg3, `java.util.Map<java.lang.String,java.lang.String>` arg4, `java.lang.String[]` arg5)`

**Returns:** [`ro.sync.ecss.imagemap.IImageMapWrapper`](./IImageMapWrapper.md)

### `getImageMap([`ro.sync.ecss.imagemap.SupportedFrameworks`](./SupportedFrameworks.md) arg0, [`ro.sync.ecss.extensions.api.AuthorAccess`](../extensions/api/AuthorAccess.md) arg1, `int` arg2, `java.net.URL` arg3, `java.util.Map<java.lang.String,java.lang.String>` arg4, `boolean` arg5, `java.lang.String[]` arg6)`
