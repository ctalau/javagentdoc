...
**Fully Qualified Name:** `ro.sync.ui.application.HelpPageProvider`
...
Used to select the main page when 
 help dialog is opened first time.

### `EDITOR_VARIABLES_PAGE_ID`

**Type:** `java.lang.String`

Used to select the help page when 
 help dialog is opened from scenario edit dialog.
...
Used to open a help dialog in case there is a need to increase the Java stack.

### `SET_PARAMETER_IN_STARTUP_SCRIPT_ID`

**Type:** `java.lang.String`

Used to open the help dialog from the OutOfmemory error dialog.
...
Ant transformation options tab.

### `DITA_OT_TRANSFORMATION_OPTIONS_TAB`

**Type:** `java.lang.String`

DITA_OT transformation options tab.
