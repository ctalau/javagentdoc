...
**Fully Qualified Name:** `ro.sync.exml.gc`
...
**Type:** `java.util.List<ro.sync.exml.ComponentsValidator>`

## Constructors

### `<init>(`java.util.List<ro.sync.exml.ComponentsValidator>` arg0)`
...
### `validateNewEditorTemplate([`ro.sync.exml.editor.EditorTemplate`](editor/EditorTemplate.md) arg0)`
