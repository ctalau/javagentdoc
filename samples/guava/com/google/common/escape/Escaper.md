...
An object that converts literal text into a format safe for inclusion in a particular context
 ...
 splitting an existing long string into short strings adaptively around {@linkplain Character#isHighSurrogate surrogate} {@linkplain Character#isLowSurrogate pairs}, or by starting
 with short strings already known to be free of unpaired surrogates.

 <p>The two primary implementations of this interface are {@link CharEscaper} and {@link UnicodeEscaper}. They are heavily optimized for performance and greatly simplify the task of
