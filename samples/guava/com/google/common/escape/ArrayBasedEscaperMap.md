...
An implementation-specific parameter class suitable for initializing {@link ArrayBasedCharEscaper} or {@link ArrayBasedUnicodeEscaper} instances. This class should be used
...
### `create([`java.util.Map<java.lang.Character,java.lang.String>`](../../../../java/util/Map.md) replacements)`
...
### `createReplacementArray([`java.util.Map<java.lang.Character,java.lang.String>`](../../../../java/util/Map.md) map)`
