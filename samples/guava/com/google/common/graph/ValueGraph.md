...
An interface for <a href="https://en.wikipedia.org/wiki/Graph_(discrete_mathematics)">graph</a>-structured data,
 ...
 <p>{@code ValueGraph} supports the following use cases (<a href="https://github.com/google/guava/wiki/GraphsExplained#definitions">definitions of
 terms</a>):
 ...
 create an instance of one of the built-in implementations of {@code ValueGraph}, use the {@link ValueGraphBuilder} class:
 ...
 the graph), you should use the non-mutating {@link ValueGraph} interface, or an {@link ImmutableValueGraph}.

 <p>You can create an immutable copy of an existing {@code ValueGraph} using {@link ImmutableValueGraph#copyOf(ValueGraph)}:
...
Returns the hash code for this graph. The hash code of a graph is defined as the hash code of a
 map from each of its {@link #edges() edges} to the associated {@link #edgeValue(Object, Object) edge value}.
