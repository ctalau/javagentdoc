...
**Fully Qualified Name:** `com.google.common.util.concurrent.NullnessCasts`
...
### `uncheckedCastNullableTToT([`T`](T.md) t)`
...
Accepts a {@code @Nullable T} and returns a plain {@code T}, without performing any check that
 ...
 <p>This method is intended to help with usages of type parameters that have {@linkplain ParametricNullness parametric nullness}. If a type parameter instead ranges over only non-null
...
Returns {@code null} cast to any type.
 ...
 <p>This method is intended to help with usages of type parameters that have {@linkplain ParametricNullness parametric nullness}. Sometimes, code may receive a null {@code T} but store
