...
**Implements:** [`com.google.common.base.Predicate<T>`](../base/Predicate.md), [`java.io.Serializable`](../../../../java/io/Serializable.md)
...
Puts an element into this {@code BloomFilter}. Ensures that subsequent invocations of {@link #mightContain(Object)} with the same element will always return {@code true}.
...
Returns the probability that {@linkplain #mightContain(Object)} will erroneously return {@code
 ...
 <p>Ideally, this number should be close to the {@code fpp} parameter passed in {@linkplain #create(Funnel, int, double)}, or smaller. If it is significantly higher, it is usually the
...
**Returns:** [`java.util.stream.Collector<T,?,com.google.common.hash.BloomFilter<T>>`](../../../../java/util/stream/Collector>.md)

Returns a {@code Collector} expecting the specified number of insertions, and yielding a {@link BloomFilter} with false positive probability 3%.
...
Returns a {@code Collector} expecting the specified number of insertions, and yielding a {@link BloomFilter} with the specified expected false positive probability.
...
### `writeTo([`java.io.OutputStream`](../../../../java/io/OutputStream.md) out)`
...
### `readFrom([`java.io.InputStream`](../../../../java/io/InputStream.md) in, [`com.google.common.hash.Funnel<? super T>`](./Funnel.md) funnel)`
