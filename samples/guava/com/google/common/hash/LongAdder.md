...
**Fully Qualified Name:** `com.google.common.hash.LongAdder`

**Extends:** [`com.google.common.hash.Striped64`](./Striped64.md)

**Implements:** `java.io.Serializable`, [`com.google.common.hash.LongAddable`](./LongAddable.md)
...
One or more variables that together maintain an initially zero `long` sum. When updates
 ...
 <p>This class extends `Number`, but does <em>not</em> define methods such as `equals`, `hashCode` and `compareTo` because instances are expected to be mutated, and
