...
**Fully Qualified Name:** `com.google.common.net.HttpHeaders`
...
The HTTP nonstandard `X-WebKit-CSP` header field name. It was introduced in <a href="https://www.w3.org/TR/2011/WD-CSP-20111129/">CSP v.1</a> and used by the Chrome until
...
The HTTP <a href="https://github.com/WICG/nav-speculation/blob/main/opt-in.md">`Supports-Loading-Mode`</a> header field name. This can be used to specify, for example, <a href="https://developer.chrome.com/docs/privacy-sandbox/fenced-frame/#server-opt-in">fenced
 frames</a>.
**Since:** 32.0.0
...
The HTTP <a href="https://iabtechlab.com/wp-content/uploads/2019/06/VAST_4.2_final_june26.pdf">`X-Device-IP`</a> header field name. Header used for VAST requests to provide the IP address of
...
The HTTP <a href="https://iabtechlab.com/wp-content/uploads/2019/06/VAST_4.2_final_june26.pdf">`X-Device-Referer`</a> header field name. Header used for VAST requests to provide the `REFERER` header value that the on-behalf-of client would have used when making a request
 itself.
**Since:** 31.0
...
The HTTP <a href="https://iabtechlab.com/wp-content/uploads/2019/06/VAST_4.2_final_june26.pdf">`X-Device-Accept-Language`</a> header field name. Header used for VAST requests to provide the
...
The HTTP <a href="https://iabtechlab.com/wp-content/uploads/2019/06/VAST_4.2_final_june26.pdf">`X-Device-Requested-With`</a> header field name. Header used for VAST requests to provide the
...
The HTTP <a href="https://goo.gl/VKpXxa">`X-Download-Options`</a> header field name.
 ...
 <p>When the new X-Download-Options header is present with the value `noopen`, the user is
...
The HTTP <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-DNS-Prefetch-Control">`X-DNS-Prefetch-Control`</a> header controls DNS prefetch behavior. Value can be "on" or "off".
...
The HTTP <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Link_prefetching_FAQ#As_a_server_admin.2C_can_I_distinguish_prefetch_requests_from_normal_requests.3F">`Purpose`</a> header field name.
**Since:** 28.0
...
The HTTP <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Link_prefetching_FAQ#As_a_server_admin.2C_can_I_distinguish_prefetch_requests_from_normal_requests.3F">`X-Purpose`</a> header field name.
**Since:** 28.0
...
The HTTP <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Link_prefetching_FAQ#As_a_server_admin.2C_can_I_distinguish_prefetch_requests_from_normal_requests.3F">`X-Moz`</a> header field name.
**Since:** 28.0
...
The HTTP <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Device-Memory">`Device-Memory`</a> header field name.
**Since:** 31.0
...
The HTTP <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Viewport-Width">`Viewport-Width`</a> header field name.
**Since:** 31.0
...
The HTTP <a href="https://wicg.github.io/user-preference-media-features-headers/#sec-ch-prefers-color-scheme">`Sec-CH-Prefers-Color-Scheme`</a> header field name.
...
The HTTP <a href="https://www.rfc-editor.org/rfc/rfc8942#name-the-accept-ch-response-head">`Accept-CH`</a> header field name.
**Since:** 31.0
...
The HTTP <a href="https://datatracker.ietf.org/doc/html/draft-davidben-http-client-hint-reliability-03.txt#section-3">`Critical-CH`</a> header field name.
**Since:** 31.0
...
The HTTP <a href="https://wicg.github.io/responsive-image-client-hints/#sec-ch-viewport-width">`Sec-CH-Viewport-Width`</a> header field name.
**Since:** 32.0.0
...
The HTTP <a href="https://wicg.github.io/responsive-image-client-hints/#sec-ch-viewport-height">`Sec-CH-Viewport-Height`</a> header field name.
**Since:** 32.0.0
...
The HTTP <a href="https://wicg.github.io/turtledove/#handling-direct-from-seller-signals">`Sec-Ad-Auction-Fetch`</a> header field name.
**Since:** 33.0.0
...
The HTTP <a href="https://wicg.github.io/turtledove/#handling-direct-from-seller-signals">`Ad-Auction-Signals`</a> header field name.
**Since:** 33.0.0
