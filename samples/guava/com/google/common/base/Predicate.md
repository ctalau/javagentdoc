...
**Extends:** [`java.util.function.Predicate<T>`](../../../../java/util/function/Predicate.md)
...
Returns the result of applying this predicate to {@code input} (Java 8 users, see notes in the
 ...
 <ul>
   ...
   <li>The computation is <i>consistent with equals</i>; that is, {@link Objects#equal Objects.equal}{@code (a, b)} implies that {@code predicate.apply(a) ==
       predicate.apply(b))}.
 </ul>
