...
### `readCount([`java.io.ObjectInputStream`](../../../../java/io/ObjectInputStream.md) stream)`
...
### `writeMap([`java.util.Map<K,V>`](../../../../java/util/Map.md) map, [`java.io.ObjectOutputStream`](../../../../java/io/ObjectOutputStream.md) stream)`
...
### `populateMap([`java.util.Map<K,V>`](../../../../java/util/Map.md) map, [`java.io.ObjectInputStream`](../../../../java/io/ObjectInputStream.md) stream)`
...
### `populateMap([`java.util.Map<K,V>`](../../../../java/util/Map.md) map, [`java.io.ObjectInputStream`](../../../../java/io/ObjectInputStream.md) stream, `int` size)`
...
### `writeMultiset([`com.google.common.collect.Multiset<E>`](./Multiset.md) multiset, [`java.io.ObjectOutputStream`](../../../../java/io/ObjectOutputStream.md) stream)`
...
### `populateMultiset([`com.google.common.collect.Multiset<E>`](./Multiset.md) multiset, [`java.io.ObjectInputStream`](../../../../java/io/ObjectInputStream.md) stream)`

**Returns:** `void`

Populates a multiset by reading an input stream, as part of deserialization. See {@link #writeMultiset} for the data format.

### `populateMultiset([`com.google.common.collect.Multiset<E>`](./Multiset.md) multiset, [`java.io.ObjectInputStream`](../../../../java/io/ObjectInputStream.md) stream, `int` distinctElements)`

**Returns:** `void`

Populates a multiset by reading an input stream, as part of deserialization. See {@link #writeMultiset} for the data format. The number of distinct elements is determined by a prior
 call to {@link #readCount}.

### `writeMultimap([`com.google.common.collect.Multimap<K,V>`](./Multimap.md) multimap, [`java.io.ObjectOutputStream`](../../../../java/io/ObjectOutputStream.md) stream)`

**Returns:** `void`

Stores the contents of a multimap in an output stream, as part of serialization. It does not
 support concurrent multimaps whose content may change while the method is running. The {@link Multimap#asMap} view determines the ordering in which data is written to the stream.
...
### `populateMultimap([`com.google.common.collect.Multimap<K,V>`](./Multimap.md) multimap, [`java.io.ObjectInputStream`](../../../../java/io/ObjectInputStream.md) stream)`

**Returns:** `void`

Populates a multimap by reading an input stream, as part of deserialization. See {@link #writeMultimap} for the data format.

### `populateMultimap([`com.google.common.collect.Multimap<K,V>`](./Multimap.md) multimap, [`java.io.ObjectInputStream`](../../../../java/io/ObjectInputStream.md) stream, `int` distinctKeys)`

**Returns:** `void`

Populates a multimap by reading an input stream, as part of deserialization. See {@link #writeMultimap} for the data format. The number of distinct keys is determined by a prior call
 to {@link #readCount}.
