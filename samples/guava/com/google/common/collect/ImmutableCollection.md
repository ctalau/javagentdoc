...
A {@link Collection} whose contents will never change, and which offers a few additional
 ...
 with {@link Collection} itself). Prefer subtypes such as {@link ImmutableSet} or {@link ImmutableList}, which have well-defined {@link #equals} semantics, thus avoiding a common source
 ...
 <ul>
   <li><b>Shallow immutability.</b> Elements can never be added, removed or replaced in this
       collection. This is a stronger guarantee than that of {@link Collections#unmodifiableCollection}, whose contents change whenever the wrapped collection
       is modified.
   ...
   <li><b>Deterministic iteration.</b> The iteration order is always well-defined, depending on
       ...
       appropriate factory method for details. View collections such as {@link ImmutableMultiset#elementSet} iterate in the same order as the parent, except as noted.
 ...
 {@link Collections#singleton(Object)} and <a href="https://docs.oracle.com/javase/9/docs/api/java/util/Set.html#immutable">{@code Set.of}</a>,
 ...
 <ul>
   ...
   <li><b>Warning:</b> a view collection such as {@link ImmutableMap#keySet} or {@link ImmutableList#subList} may retain a reference to the entire data set, preventing it from
...
### `removeAll([`java.util.Collection<?>`](../../../../java/util/Collection.md) oldElements)`
...
### `removeIf([`java.util.function.Predicate<? super E>`](../../../../java/util/function/Predicate.md) filter)`
...
### `retainAll([`java.util.Collection<?>`](../../../../java/util/Collection.md) elementsToKeep)`
