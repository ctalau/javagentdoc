...
Fixed-size {@link Table} implementation backed by a two-dimensional array.
 ...
 null-hostile method like {@link ImmutableTable#copyOf}. For alternatives, please see <a href="https://github.com/google/guava/wiki/NewCollectionTypesExplained#table">the wiki</a>.
...
### `set(`int` rowIndex, `int` columnIndex, [`V`](V.md) value)`
...
**Returns:** [`java.util.Set<com.google.common.collect.Table.Cell<R,C,@org.checkerframework.checker.nullness.qual.Nullable V>>`](../../../../java/util/Set>.md)
...
**Returns:** [`java.util.Iterator<com.google.common.collect.Table.Cell<R,C,@org.checkerframework.checker.nullness.qual.Nullable V>>`](../../../../java/util/Iterator>.md)

### `cellSpliterator()`

**Returns:** [`java.util.Spliterator<com.google.common.collect.Table.Cell<R,C,@org.checkerframework.checker.nullness.qual.Nullable V>>`](../../../../java/util/Spliterator>.md)
...
**Returns:** [`java.util.Map<R,@org.checkerframework.checker.nullness.qual.Nullable V>`](../../../../java/util/Map.md)
...
**Returns:** [`java.util.Map<C,java.util.Map<R,@org.checkerframework.checker.nullness.qual.Nullable V>>`](../../../../java/util/Map>.md)

### `row([`R`](R.md) rowKey)`

**Returns:** [`java.util.Map<C,@org.checkerframework.checker.nullness.qual.Nullable V>`](../../../../java/util/Map.md)

Returns a view of all mappings that have the given row key. If the row key isn't in {@link #rowKeySet()}, an empty immutable map is returned.
...
**Returns:** [`java.util.Map<R,java.util.Map<C,@org.checkerframework.checker.nullness.qual.Nullable V>>`](../../../../java/util/Map>.md)

### `values()`

**Returns:** [`java.util.Collection<@org.checkerframework.checker.nullness.qual.Nullable V>`](../../../../java/util/Collection.md)
...
**Returns:** [`java.util.Iterator<@org.checkerframework.checker.nullness.qual.Nullable V>`](../../../../java/util/Iterator.md)

### `valuesSpliterator()`

**Returns:** [`java.util.Spliterator<@org.checkerframework.checker.nullness.qual.Nullable V>`](../../../../java/util/Spliterator.md)
